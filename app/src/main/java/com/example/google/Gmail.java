...
import com.example.google.fragmens.Principal;
...
public class Gmail extends AppCompatActivity {
    ...
    public void setFragmetDefault(){
        cambiarfradmento(new Principal(),navigationView.getMenu().findItem(R.id.menu_principal));
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setQueryHint("Buscar Correo electrónico");
